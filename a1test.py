...
def testB():
    ...
    result=a1.has_error('{"from":"","to":"","success":false,"error":"Source currency code is invalid."}')
    ...
    result=a1.has_error('{ "from" : "80 Gibraltar Pounds", "to" : "2349.5741654147 Ethiopian Birr", "success" : true, "error" : "" }')
    cornelltest.assert_equals(False,result)
